...
QT_MOC_LITERAL(1, 9, 8), // "iChanged"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 14) // "myStateChanged"

    },
    "checkbox\0iChanged\0\0myStateChanged"
};
...
void checkbox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->myStateChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (checkbox::*_t)(QObject * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&checkbox::iChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject checkbox::staticMetaObject = {
    { &QRadioButton::staticMetaObject, qt_meta_stringdata_checkbox.data,
...
// SIGNAL 0
void checkbox::iChanged(QObject * _t1)
{
