...
QT_MOC_LITERAL(3, 19, 20) // "myCurrentFontChanged"

    },
    "combobox\0iChanged\0\0myCurrentFontChanged"
};
...
void combobox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->myCurrentFontChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (combobox::*_t)(QObject * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&combobox::iChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void combobox::iChanged(QObject * _t1)
{
