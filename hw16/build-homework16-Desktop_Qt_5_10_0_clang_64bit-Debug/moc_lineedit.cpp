...
QT_MOC_LITERAL(3, 19, 17) // "myEditingFinished"

    },
    "LineEdit\0iChanged\0\0myEditingFinished"
};
...
void LineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (LineEdit::*_t)(QObject * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LineEdit::iChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LineEdit::iChanged(QObject * _t1)
{
