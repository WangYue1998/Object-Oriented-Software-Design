...
QT_MOC_LITERAL(1, 7, 13), // "sliderChanged"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 9), // "setslider"
QT_MOC_LITERAL(4, 32, 4) // "size"

    },
    "slider\0sliderChanged\0\0setslider\0size"
};
...
void slider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sliderChanged((*reinterpret_cast< QObject*(*)>(_a[1]))); break;
        case 1: _t->setslider((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (slider::*_t)(QObject * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&slider::sliderChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void slider::sliderChanged(QObject * _t1)
{
