...
QT_MOC_LITERAL(3, 21, 21) // "myCurrentValueChanged"

    },
    "mycomboBox\0iChanged\0\0myCurrentValueChanged"
};
...
void mycomboBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->myCurrentValueChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (mycomboBox::*_t)(QObject * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mycomboBox::iChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void mycomboBox::iChanged(QObject * _t1)
{
