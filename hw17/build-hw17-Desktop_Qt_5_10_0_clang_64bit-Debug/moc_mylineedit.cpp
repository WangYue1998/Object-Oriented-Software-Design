...
QT_MOC_LITERAL(3, 21, 17) // "myEditingFinished"

    },
    "MyLineEdit\0iChanged\0\0myEditingFinished"
};
...
void MyLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->myEditingFinished(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (MyLineEdit::*_t)(QObject * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLineEdit::iChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyLineEdit::iChanged(QObject * _t1)
{
