...
QT_MOC_LITERAL(3, 24, 9), // "setslider"
QT_MOC_LITERAL(4, 34, 4) // "size"

    },
    "MySlider\0sliderChanged\0\0setslider\0"
    "size"
};
...
void MySlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MySlider::*_t)(QObject * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MySlider::sliderChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MySlider::sliderChanged(QObject * _t1)
{
